...
from ckanext.filterview import blueprint
...
class DataTablesView(p.SingletonPlugin):
    ...
    def update_config(self, config: CKANConfig):
        ...
        toolkit.add_resource(u'assets', u'ckanext-filterview')
    ...
    def info(self) -> dict[str, Any]:
        return {
            ...
            u'schema': {
                ...
                u'client_side_filtering': [default(False), boolean_validator],
                u'client_side_max_rows': [default(10000), natural_number_validator],
            }
        }
